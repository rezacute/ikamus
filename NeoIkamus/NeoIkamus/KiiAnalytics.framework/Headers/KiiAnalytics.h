...
+ (void)beginWithID:(NSString *)appId andKey:(NSString *)appKey andURL:(NSString *)url;
...
/** Initialize the KiiAnalytics SDK
 ...
 @param appId The application ID found in your Kii developer console
 @param appKey The application key found in your Kii developer console
 @param kiiSite One of the enumerator constants kiiAnalyticsSiteUS (United States),
 kiiAnalyticsSiteJP (Japan), kiiAnalyticsSiteCN (China), kiiAnalyticsSiteSG (Singapore)
